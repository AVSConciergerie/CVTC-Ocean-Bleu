...
contract CVTCPremiumSimple is Ownable(msg.sender), ReentrancyGuard {
    IERC20 public cvtcToken;
    ICVTCSwap public cvtcSwap;

    // Configuration du système d'échelonnement P2P - Intervalles mensuels
    ...
    uint256 public constant MAX_STAGGERED_STEPS = 6; // Maximum 6 échelons
    ...
    // Structures pour les transferts échelonnés
    ...
    // SUPPRESSION DE LA CONTRAINTE PREMIUM - Tout le monde peut utiliser !

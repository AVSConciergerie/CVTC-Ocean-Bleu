...
/**
 * @title CVTCPaymaster
 * @notice Paymaster contract for CVTC token on BSC Testnet.
 * @dev Handles gas payments in CVTC tokens for ERC-4337 user operations.
 * Key improvements:
 * - Proper decimal handling for CVTC (2 decimals)

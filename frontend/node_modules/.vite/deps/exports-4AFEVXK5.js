...
var AppKit = class extends AppKitBaseClient {
  ...
  async loadModalComponents(features, remoteFeatures) {
    ...
    if (usingEmbeddedWallet) {
      featureImportPromises.push(import("./embedded-wallet-P5DNGUBU.js"));
    }
    if (remoteFeatures.email) {
      featureImportPromises.push(import("./email-FBNGZYW7.js"));
    }
    if (remoteFeatures.socials) {
      featureImportPromises.push(import("./socials-BBVQW245.js"));
    }
    if (remoteFeatures.swaps && remoteFeatures.swaps.length > 0) {
      featureImportPromises.push(import("./swaps-2JQE4WGE.js"));
    }
    if (features.send) {
      featureImportPromises.push(import("./send-VWI47K7Y.js"));
    }
    if (features.receive) {
      featureImportPromises.push(import("./receive-LNBBPH7O.js"));
    }
    if (remoteFeatures.onramp && remoteFeatures.onramp.length > 0) {
      featureImportPromises.push(import("./onramp-IQ5S2UET.js"));
    }
    if (remoteFeatures.activity) {
      featureImportPromises.push(import("./transactions-R6IYN4B2.js"));
    }
    if (features.pay) {
      featureImportPromises.push(import("./exports-AZO5VOPG.js"));
    }
    if (remoteFeatures.emailCapture) {
      featureImportPromises.push(import("./ui-LJQVZUUM.js"));
    }
    await Promise.all([
      ...featureImportPromises,
      import("./exports-NNV2MDLA.js"),
      import("./w3m-modal-H3U25PWD.js")
    ]);
  }
};
...
//# sourceMappingURL=exports-4AFEVXK5.js.map

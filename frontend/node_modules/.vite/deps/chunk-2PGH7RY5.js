...
var controller14 = {
  ...
  async fetchTokens() {
    ...
    const networkToken = state21.myTokensWithBalance?.find((token) => token.address === networkAddress);
    if (networkToken) {
  ...
  async sendTransactionForApproval(data) {
    ...
    try {
      ...
      const error = err;
      state21.transactionError = error?.displayMessage;
      state21.loadingApprovalTransaction = false;
...
//# sourceMappingURL=chunk-2PGH7RY5.js.map

...
async function recoverPublicKey({ hash, signature }) {
  ...
  const { secp256k1: secp256k12 } = await import("./secp256k1-T6IN6Y2R.js");
  const signature_ = (() => {
...
function assertTransactionEIP4844(transaction) {
  ...
  if (blobVersionedHashes) {
    ...
    for (const hash of blobVersionedHashes) {
      ...
      const version = hexToNumber(slice2(hash, 0, 1));
      if (size_ !== 32)
...
function encode4(abiConstructor, options) {
  ...
  return concat(bytecode, abiConstructor.inputs?.length && args?.length ? encode3(abiConstructor.inputs, args) : "0x");
}
...
//# sourceMappingURL=chunk-JO2J66W2.js.map

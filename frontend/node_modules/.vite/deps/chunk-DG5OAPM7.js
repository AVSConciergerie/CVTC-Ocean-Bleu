...
import {
  HashMD
} from "./chunk-CDTV4FXR.js";
import {
  LruMap,
  defineFormatter,
  hexToNumber,
  numberToHex
} from "./chunk-ARJKGYGS.js";
import {
  keccak_256
...
function Lc() {
  ...
  return { privateKey: toString2(t2, G), publicKey: toString2(e2, G) };
}
function jc() {
  const t2 = Lt(hn);
  return toString2(t2, G);
}
function Cc(t2, e2) {
  const n3 = fn.getSharedSecret(fromString3(t2, G), fromString3(e2, G)), r2 = Vs(Qt, n3, void 0, void 0, hn);
  return toString2(r2, G);
}
function Pc(t2) {
  const e2 = Qt(fromString3(t2, G));
  return toString2(e2, G);
}
function kc(t2) {
  const e2 = Qt(fromString3(t2, Kt));
  return toString2(e2, G);
}
function pn(t2) {
  return fromString3(`${t2}`, ln);
}
function Bt(t2) {
  return Number(toString2(t2, ln));
}
function no(t2) {
...
function Vc(t2) {
  ...
  const n3 = typeof t2.senderPublicKey < "u" ? fromString3(t2.senderPublicKey, G) : void 0, r2 = typeof t2.iv < "u" ? fromString3(t2.iv, G) : Lt(oe), o2 = fromString3(t2.symKey, G), i3 = $r(o2, r2).encrypt(fromString3(t2.message, Kt)), s2 = gn({ type: e2, sealed: i3, iv: r2, senderPublicKey: n3 });
  return t2.encoding === xe ? no(s2) : s2;
}
function Mc(t2) {
  const e2 = fromString3(t2.symKey, G), { sealed: n3, iv: r2 } = Se({ encoded: t2.encoded, encoding: t2.encoding }), o2 = $r(e2, r2).decrypt(n3);
  if (o2 === null) throw new Error("Failed to decrypt");
  return toString2(o2, Kt);
}
function Dc(t2, e2) {
  const n3 = pn(re), r2 = Lt(oe), o2 = fromString3(t2, Kt), i3 = gn({ type: n3, sealed: o2, iv: r2 });
  return e2 === xe ? no(i3) : i3;
}
function Hc(t2, e2) {
  const { sealed: n3 } = Se({ encoded: t2, encoding: e2 });
  return toString2(n3, Kt);
}
function gn(t2) {
  if (Bt(t2.type) === re) return toString2(concat3([t2.type, t2.sealed]), qt);
  if (Bt(t2.type) === Ft) {
    if (typeof t2.senderPublicKey > "u") throw new Error("Missing sender public key for type 1 envelope");
    return toString2(concat3([t2.type, t2.senderPublicKey, t2.iv, t2.sealed]), qt);
  }
  return toString2(concat3([t2.type, t2.iv, t2.sealed]), qt);
}
function Se(t2) {
  const e2 = (t2.encoding || qt) === xe ? ro(t2.encoded) : t2.encoded, n3 = fromString3(e2, qt), r2 = n3.slice($c, eo), o2 = eo;
  if (Bt(r2) === Ft) {
...
function qc(t2, e2) {
  ...
  return oo({ type: Bt(n3.type), senderPublicKey: typeof n3.senderPublicKey < "u" ? toString2(n3.senderPublicKey, G) : void 0, receiverPublicKey: e2?.receiverPublicKey });
}
function oo(t2) {
  const e2 = t2?.type || dn;
  if (e2 === Ft) {
...
function io(t2) {
  ...
  return concat3([new Uint8Array([4]), e2, n3]);
}
function zc(t2, e2) {
  ...
  if (!_c.verify(concat3([s2, c3]), u3, l4)) throw new Error("Invalid signature");
...
*/
//# sourceMappingURL=chunk-DG5OAPM7.js.map
